...
// Doubles as the "여행 정보 다시 설정하기" edit screen from /profile — in that
// case the fields are prefilled with the saved profile instead of starting
// blank, and a back link to /profile replaces the onboarding step dots.
    ...
    <main className="mx-auto flex min-h-dvh w-full max-w-sm flex-col items-center justify-between px-6 py-10">
      <div className="flex w-full flex-col gap-7">
        ...
        <h1 className="text-lg font-bold">
          {isEditing ? "여행 정보를 수정해볼까요?" : "마지막이에요! 학습 계획을 정해볼까요?"}
        </h1>
